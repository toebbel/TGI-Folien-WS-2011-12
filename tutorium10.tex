...
\begin{itemize}
  ...
  \item Welche Zeichenketten k\"onnen in vier Schritten abgeleitet werden?

  \item Sei $\alpha = (b^*ab^*ab^*)^+$ ein regul\"arer Ausdruck.
        Zeigen Sie: $L(\alpha) \subseteq L(G)$.
\end{itemize}
\end{frame}
...
Konstruieren Sie eine Typ-1-Grammatik, welche die Sprache
...
Geben Sie unter Anwendung des Verfahrens aus Satz 5.5 eine Grammatik an,
