...
\item $\menge{a\#b}{a,b \in \{0,1\}^* \mbox{ und } x \neq y}$
\end{enumerate}
}{
\begin{enumerate}
...
\aufgaben{
\begin{enumerate}
	\item Sei ein 2S-PDA definiert als Kellerautomat mit einem zusätzlichen zweiten Stack. In jedem Schritt wird ein Symbol von der Eingabe und von beiden Stacks gelesen und ein Symbol auf den ersten und den zweiten Stack geschrieben. \begin{enumerate}
